...
<head>
    ...
    <title>CareerBridge-Admin</title>
</head>
...
<body>
    ...
    <div class="wrapper">
        <!--start top header-->
        @include('backend.admin.partial.top_header')
        <!--end top header-->

        <!--start sidebar -->
        @include('backend.admin.partial.asidebar')
        <!--end sidebar -->
        ...
        <!--start switcher-->
        @include('backend.admin.partial.colorchnager')
        <!--end switcher-->
