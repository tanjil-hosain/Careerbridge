...
<head>
    ...
    <title>CareerBridge-Employer</title>
</head>
...
<body>
    ...
    <div class="wrapper">
        <!--start top header-->
        @include('backend.employer.partial.topbar')
        <!--end top header-->

        <!--start sidebar -->
        @include('backend.employer.partial.asidebar')
        <!--end sidebar -->
        ...
        <!--start switcher-->
        @include('backend.employer.partial.change-color')
        <!--end switcher-->
